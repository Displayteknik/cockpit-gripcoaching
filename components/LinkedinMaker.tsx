...
// customerMode = kundvyn (/k/linkedin). LinkedIn-motorn har inga byrå-only-bitar
// (allt är klient-scopat innehåll), så props finns för framtida behov men inget döljs.
export default function LinkedinMaker({ customerMode = false }: { customerMode?: boolean }) {
  void customerMode;

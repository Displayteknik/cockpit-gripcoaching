...
// customerMode = kundvyn (/k/ikigai). Inga byrå-only-bitar → props finns för framtida behov.
export default function IkigaiMaker({ customerMode = false }: { customerMode?: boolean }) {
  void customerMode;

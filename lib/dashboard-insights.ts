...
export function computeFocusInsights(data: InsightInput): FocusInsight[] {
  ...
  // Ingen kontext-blind fallback: har kunden ingen sök/trafik-data returnerar vi tomt.
  // Callern (översikten) visar då konkreta modul-actions istället, och Statistik döljer
  // sektionen. Så vi aldrig visar en återvändsgränd ("fyll i profil" när den är ifylld).
  return insights;
}

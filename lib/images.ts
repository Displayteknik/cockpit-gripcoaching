...
${mode === "overlay" ? "Muted tones suitable for white text overlay — but never depressing." : "Beautiful composition, sharp focus, on-brand emotional tone."}`;
  ...
  // fel när den gör det. Grinden läser av, begär omtag, och ber till sist om ett
  // TEXTLÖST MOTIV (BILD-8c: aldrig en tom skylt, den läses som trasig).

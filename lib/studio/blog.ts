...
export async function generateBlogArticle(opts: BlogGenOpts): Promise<BlogArticle> {
  ...
  const system = [
    ...
    "\n=== STRUKTUR (modern, skannbar, LUFTIG — mycket viktigt) ===",
    "- FÖRSTA stycket = lead: <p class=\"lead\">stark krok (enligt playbooken) + löfte om vad läsaren får ut.</p>",
    "- Därefter 4–6 <h2>-sektioner med beskrivande, sökordsnära rubriker. <h3> för undersektioner. Varje <h2> följs av 1 kort inledande stycke.",
    "- KORTA stycken: MAX 2–3 meningar per <p>. Bryt hellre i flera stycken än en textvägg. Aldrig ett stycke längre än 4 rader.",
    "- Räkna ALDRIG upp fördelar, egenskaper, för/nackdelar eller alternativ som fetstil inuti ett stycke (t.ex. '<strong>Alltid på:</strong> ...'). Det MÅSTE vara en riktig lista: <ul><li><strong>Term</strong> — kort förklaring.</li>…</ul>. Minst 2 sådana listor i artikeln.",
    "- Använd <ol> för steg-för-steg. <blockquote> för en central insikt/tumregel. <strong> bara för enstaka nyckelbegrepp i löptext.",
    ...
    "- Avsluta med <h2>Vanliga frågor</h2> (3–4 <h3>-frågor, varje med 1–2 styckes svar) och ett kort avslutande stycke med uppmaning att höra av sig/boka.",

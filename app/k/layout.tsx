    ...
    <div className="min-h-screen bg-gray-50 flex">
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col flex-shrink-0 sticky top-0 h-screen overflow-y-auto">
        ...
        <div className="p-4 border-t border-gray-100">
          {/* Kunden är kvar i GHL-hubben — Cockpit är satelliten. Alltid en väg tillbaka. */}
          <a
            href="https://app.mysales.se"
            className="w-full flex items-center gap-2 text-sm text-gray-500 hover:text-gray-900 px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors mb-1"
          >

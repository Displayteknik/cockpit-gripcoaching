...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const uppdrag = [
      ...
      "BEHÅLL ALLTID originalets målgruppsmarkör (kön, ålder, roll, bransch, livssituation) och KOMBINERA den med symptomspråket. Står det 'Om du är en kvinna som ...' ska förbättringen fortfarande säga 'Om du är en kvinna som ...' följt av symptomet. Stryk aldrig markören, den avgör vem som känner sig träffad.",
      "Skriv enkel, idiomatisk svenska. Undvik konstruerade fraser som 'ett liv som verkligen är du'. Säg hellre 'ett liv som känns som ditt'.",
      "",
      ...
      "Notera vad som hände: målgruppsmarkören 'en kvinna' behölls och kombinerades med symptomet, skuldavlastning med expertens term i förklaringen, kännbar transformation, versalt svarsord, bestämt verb, kostnadsfritt, och 'där jag berättar mer' struket.",
      "",
      "=== ANALYSEN ===",

...
// Flyttad hit från /dashboard/hq (REV-0, HQ-1): den här sidan är en genvägslista
// med egen mörk stil, inte en del av produkten. Den ligger kvar på egen adress men
// utanför menyn. Founder HQ på /dashboard/hq länkar hit.
export default function GenvagarPage() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight">Genvägar och appar</h1>
              <p className="text-xs text-slate-500">Håkan Grip · länklista utanför menyn</p>
            </div>
          </div>
        ...
        <div className="text-center text-xs text-slate-600 pt-8 mt-8 border-t border-slate-800">
          Genvägar · uppdatera via <code className="text-slate-500">app/dashboard/genvagar/page.tsx</code>
        </div>
      </div>
    </div>
  );

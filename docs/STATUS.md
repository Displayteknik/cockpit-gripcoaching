...
| Grupp B2 — Vilande saknas i pipelinevyn | BESTÄLLT, EJ PÅBÖRJAT | **Blockeringen upplöst 9/8 av Håkan:** Vilande är ett EGET steg (finns redan i GHL:s Kund pipeline, sannolikhet 10, med `aterkontakt_datum`) — Cockpit speglar GHL rakt av, aldrig egen parallell vokabulär. `lobby_contacts` får en stegkolumn som speglar GHL:s steg-id. I UI:t visas Vilande som **VILOZON** bredvid Bokad/Förlorad, inte som femte aktiv kolumn: de fyra kolumnerna är arbetsytan, Vilande är en parkering. Regler: flytt till Vilande KRÄVER återkontaktsdatum (annars Förlorad); när datumet inträffar skapas uppgift i Fokus idag och kortet lyfts tillbaka till Dialog. Femfas-mappning: FRAMTID = Vilande, SLÄPPT = Förlorad | Ja | Nej |
...
| Grupp C2 — språkgenomgång av kundvyn | BESTÄLLT, EJ PÅBÖRJAT | Spec 9/8: nivånamn, rubriker, knapptexter talar fackspråk ("Belagd", "Vinnande exempel"). Förklaringstexterna är bra och ska styra namnsättningen. Måttstock: en 55-årig terapeut ska förstå ordet utan förklaring | **Ja** | Nej |
| Grupp C3 — tre småfel | BESTÄLLT, EJ PÅBÖRJAT | Spec 9/8: (a) rubriken "De tre sakerna som höjer textkvaliteten mest just nu" listar två, (b) veckoplanens DT-platshållare, (c) Inflödets LinkedIn-mål 20/v är opassande för en terapeut — kanaler och veckomål ska vara per tenant | **Ja** | **Ja** — rubriken lovar tre, ger två |

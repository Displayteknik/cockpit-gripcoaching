...
| Skenfrågegrinden utanför captionvägen | BESTÄLLT, EJ PÅBÖRJAT | Grind finns bara i `sakerstallCaption`. Veckoplan, karusell, reels, blogg, nyhetsbrev, LinkedIn har bara promptregeln → G-2 | Ja | Nej |
| Hashtags-flödet utanför prompt-core | BESTÄLLT, EJ PÅBÖRJAT | `generate/hashtags/route.ts:59` bygger egen prompt. Beslut: in i G-2 | Ja | Nej |
...
| Grupp B2 — Vilande saknas i pipelinevyn | BESTÄLLT, EJ PÅBÖRJAT | Blockerad: `lobby_contacts` har ingen `stage`-kolumn. Två vokabulär (new/contacted/dialog/ready/passed mot new/acknowledge/connect/offer/won/lost) måste mappas mot GHL:s sju steg först | Ja | Nej |
| Grupp C | BESTÄLLT, EJ PÅBÖRJAT | Ingen spec i repot — den lever i Håkans ordning. Beslutad plats: efter G-2, före G-3 | Ja | Nej |

...
| **H — Karusellen** | `ark-karusell` (slides[] i payload, multi-PNG-export, GHL-publicering med flera media) | 5-slide-karusell renderad + publicerad som utkast | IG:s viktigaste format med riktig render |

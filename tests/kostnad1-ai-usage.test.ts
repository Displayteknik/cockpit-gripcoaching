...
import { klassaFel, beraknaKostnad, felklassText, ROD_FELKLASS } from "@/lib/ai-usage";
...
describe("KOSTNAD-1 · felklassning: statuskoden ensam räcker inte", () => {
  ...
  it("larmtexten är klarspråk och pekar ut åtgärden", () => {
    expect(felklassText("billing", "gemini")).toContain("betalningsfel");
    expect(felklassText("auth", "gemini")).toContain("nyckeln");
    // Inga tankstreck i UI-text (skrivreglerna).
